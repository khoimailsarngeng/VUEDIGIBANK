  ...
  <div>
    ...
    >
      <q-carousel-slide
        ...
        :name="1"
        :img-src="mobileMode ? '/assets/img/bg-mobile-with-app.png' : '/assets/img/bg-mobile-with-app.png'"
      />
          ...
          <q-card
            ...
            :style="
              mobileMode
                ...
                : window.width <= 1366
                ? 'border:0;margin-top:50px;padding-right:550px'
                : 'border:0;margin-top:150px;padding-right:650px'
            "
          >
            <q-card-section>
