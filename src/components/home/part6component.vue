<template>
  <div class="contact-footer">
      ...
      <template v-slot:control>
        <q-carousel-control :position="mobileMode ? 'top' : 'top'" class="q-gutter-xs text-center">
          <q-card flat bordered class="my-card bg-transparent full-width" style="border:0;width">
            <q-card-section>
              <span :class="mobileMode ? 'text-h5 text-white' : 'text-h4 text-white'">Hotline 1440</span>&nbsp;
              <br />
              <br />
              <span :class="mobileMode ? 'q-font-15 text-white cls-text-hotline' : 'text-h5 text-white cls-text-hotline'"
                >LVBDigibank Hotline 020-52220222</span
              >
              <br />
              <br />
              <span class="text-h6 text-white">LAO VIET JOINT VENTURE BANK (LAOVIETBANK)</span>
              <br />
              <span :class="mobileMode ? 'text-h7 text-white' : 'text-h7'">
                Địa chỉ: Số 44 Đại lộ Lanexang, Bản Hat Sa Đy, Quận Chăn Thạ Bu Ly, Thủ đô Viêng Chăn, CHDCND Lào
                <br />Số điện thoại: 0085621-251418, 216316, 214377 <br />Fax: 0085621-212197 <br />SWIFT Code: LAOVLALA
              </span>
            </q-card-section>
          </q-card>
        </q-carousel-control>
    ...
    <div v-if="mobileMode" class="footer">
      <img
    ...
    <div v-else class="footer-web">
      <span>
        ...
        <img src="/assets/img/icon-www.svg" height="16px" />laovietbank.com.la <img src="/assets/img/icon-facebook.svg" height="16px" /> LaoVietBank
      </span>
    </div>
  </div>
</template>
...
.footer-web {
  height: 50px;
  background: rgb(0, 54, 148);
  background: linear-gradient(0deg, rgba(0, 54, 148, 1) 0%, rgba(27, 82, 179, 1) 100%);
  text-align: center;
  padding-top: 12px;
  color: #ffffff;
  font-size: 16px;
