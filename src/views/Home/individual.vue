<template>
  <div class="bg-img-individual" :style="returnData.length > 7 ? `height:100%` : `height:${window.height + 150}px`">
    ...
    <div class="row q-col-gutter-xs q-mt-md">
      ...
      <div :class="mobileMode ? 'col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center q-pt-lg' : 'col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center q-pt-lg'">
        <span style="color: #17479b" :class="mobileMode ? 'q-font-18 text-bold' : 'q-font-26 text-bold'">{{ $t('Individualcustomer') }}</span>
      </div>
      <div
        :class="
        ...
        <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4" v-for="(item, index) in returnData" :key="index">
          ...
          >
            <q-card-section class="product-thumb" text-center>
              <img :width="mobileMode ? '100px' : '250px'" :height="mobileMode ? '100px' : '250px'" :src="item.img" />
            </q-card-section>
